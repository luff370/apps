...
<div class="wrap">
    ...
    <div class="card">
        ...
        <div data-lang="en">
            <p>You can request deletion of your {{ $app_name }} account and related data in either of the following ways. You do not need to keep the app installed.</p>
            <ol>
        ...
        <div data-lang="zh">
            <p>你可以通过以下任一方式申请删除 {{ $app_name }} 账号及相关数据，无需保持应用已安装。</p>
            <ol>

...
class ChatService
{
    ...
    public function onWorkerStart(Worker $worker)
    {
        ...
        Timer::add(2, function () use (&$worker) {
            ...
            if ($kefuUid) {
                /** @var StoreServicesService $kefuService */
                $kefuService = app(StoreServicesServices::class);
                $kefuServices->updateOnline(['notUid' => $kefuUid], ['online' => 0]);
            }
        });
    }

 ...
 */
class SystemNotificationServices extends Service
{
    /**
    ...
    public function saveData(array $data)
    {
        ...
        switch ($type) {
            ...
            case 'is_ent_wechat':
                ...
                $res = $this->dao->update((int) $id, $update);
                break;
            case 'is_wechat_group':
                $update['name'] = $data['name'];
                $update['title'] = $data['title'];
                $update['is_wechat_group'] = $data['is_wechat_group'];
                $update['wechat_group_text'] = $data['wechat_group_text'];
                $res = $this->dao->update((int) $id, $update);
                break;
            case 'is_fly_book':
                $update['name'] = $data['name'];
                $update['title'] = $data['title'];
                $update['is_fly_book'] = $data['is_fly_book'];
                $update['fly_book_text'] = $data['fly_book_text'];
                $update['fly_book_url'] = $data['fly_book_url'];
                $res = $this->dao->update((int) $id, $update);
                break;
        }

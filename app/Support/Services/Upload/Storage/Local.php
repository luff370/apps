...
use App\Support\Utils\DownloadImage;
 ...
 * Class Local
 *
 * @package App\Support\Services\Upload\storage
 */
class Local extends BaseUpload
{
    ...
    public function text(string $filePath, array $waterConfig = [])
    {
        ...
        try {
            ...
            $Image->text($waterConfig['watermark_text'], $waterConfig['watermark_text_font'], $waterConfig['watermark_text_size'], $waterConfig['watermark_text_color'], $waterConfig['watermark_position'], [
                $waterConfig['watermark_x'],
                $waterConfig['watermark_y'],
                $waterConfig['watermark_text_angle'],
            ])->save($savePath);
        } catch (\Throwable $e) {

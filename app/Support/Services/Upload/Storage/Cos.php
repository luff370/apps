        ...
        if ($waterConfig['image_watermark_status'] && $filePath) {
            ...
            switch ($waterConfig['watermark_type']) {
                case 1://图片
                    ...
                    $waterPath =
                    $filePath .= '/1/image/' . base64_encode($waterConfig['watermark_image']) . '/gravity/' . ($this->position[$waterConfig['watermark_position']] ?? 'northwest') . '/blogo/1/dx/' . $waterConfig['watermark_x'] . '/dy/' . $waterConfig['watermark_y'];
                    break;
                case 2://文字
